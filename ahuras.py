...
class SchoolClassifier:
    def __init__(self):
        ...
        self.school_types = {
            ...
            "eスポーツ塾": ["eスポーツ教室", "eスポーツ塾", "ゲーミング塾", "プロゲーマー塾","eスポーツスクール", "ゲーム塾", "ゲーミングスクール", "eスポーツクラブ"],
            "専門学校": ["専門学校", "専門学院", "職業訓練校", "技術学校", "専修学校"],
            "eスポーツ専門学校": ["学校", "eスポーツ高等学院", "eスポーツ学科", "eスポーツコース", "eスポーツ専攻", "ゲーム学科","デジタルエンターテインメント学科", "情報ゲーム学科", "ゲームクリエイター学科","eスポーツビジネス学科", "プロゲーマー養成コース", "eスポーツマネジメント学科"],  # 新規追加
